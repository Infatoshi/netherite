...
Usage:
  uv run --no-project python c/magma/raster/verify/mc_capture/instrumented_capture.py
...
REPO = Path(__file__).resolve().parents[5]  # .../mc_capture/verify/raster/magma/c -> repo
JAVA = REPO / "java"
