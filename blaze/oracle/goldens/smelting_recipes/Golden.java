// Verbatim MC 1.11.2 FurnaceRecipes + TileEntityFurnace.getItemBurnTime over a selected
// behavior battery. Item and block numbers are the live Java 1.11.2 registry ids.
...
public class Golden {
    ...
    /* live item registry ids */
    static final Item COAL = new Item(263), DIAMOND = new Item(264), IRON_INGOT = new Item(265),
        GOLD_INGOT = new Item(266), STICK = new Item(280), REDSTONE = new Item(331),
        LAVA_BUCKET = new Item(327), PORKCHOP = new Item(319), COOKED_PORKCHOP = new Item(320),
        FISH = new Item(349), COOKED_FISH = new Item(350), DYE = new Item(351),
        BEEF = new Item(363), COOKED_BEEF = new Item(364), CHICKEN = new Item(365),
        COOKED_CHICKEN = new Item(366), MUTTON = new Item(423), COOKED_MUTTON = new Item(424),
        RABBIT = new Item(411), COOKED_RABBIT = new Item(412), ROTTEN_FLESH = new Item(367),
        BLAZE_ROD = new Item(369), EMERALD = new Item(388), POTATO = new Item(392),
        BAKED_POTATO = new Item(393), QUARTZ = new Item(406), CHORUS_FRUIT = new Item(432),
        CHORUS_FRUIT_POPPED = new Item(433);
