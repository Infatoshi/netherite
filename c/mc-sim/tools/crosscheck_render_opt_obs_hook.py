#!/usr/bin/env python3
"""Cross-check mc-sim render_opt_obs_hook vs render-opt kernel 15_light_combine_pack.
...
and compares packed outputs to mc-sim hook hex dump (bitwise on the low 32 bits).
...
def _render_opt_root():
    for rel in ("ref/render-opt", "../mc-1.11.2-env/c/render-opt"):
