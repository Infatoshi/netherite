...
cd "$ROOT"
make game/portal_live.o game/world_live.o game/caps.o world/light.o world/mesh_mc.o \
...
${CC:-gcc} -O2 -ffp-contract=off -Wall -Wextra -I. -Icore -I"$MCSIM/core" \
	game/test_portal_live.c game/portal_live.o game/world_live.o game/caps.o world/light.o \
