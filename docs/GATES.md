...
| 4 | Port-matrix rows after spawn-to-torch: projectiles, explosions, mobs, chests, portals_dimensions, nether_route, dragon_victory, boats_elytra_xp. fluids, random_ticks, entity_spine, falling_blocks, and weather_optional VERIFIED 2026-08-22. | 2 | grindable DAG | anvil cpu then gpu |
