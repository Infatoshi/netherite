...
{
    GmFluidLive regions;
    gm_fluid_init(&regions);
    regions.dim = -1;
    regions.reg[0].active = 1;
    regions.reg[0].x0 = regions.reg[0].x1 = 0;
    regions.reg[0].y0 = regions.reg[0].y1 = 64;
    regions.reg[0].z0 = regions.reg[0].z1 = 0;
    regions.reg[1].active = 1;
    regions.reg[1].x0 = regions.reg[1].x1 = 100;
    regions.reg[1].y0 = regions.reg[1].y1 = 64;
    regions.reg[1].z0 = regions.reg[1].z1 = 100;
    gm_fluid_forget_near(&regions, -1, 0, 64, 0, 5);
    CHECK(!regions.reg[0].active && regions.reg[1].active,
          "exact-fluid ownership retires only the overlapping CA region");
