...
Also dumps /tmp/craster_atlas.png for eyeballing.
"""
import os
import tempfile
import zipfile
...
DUMP_PNG = "/tmp/craster_atlas.png"
...
def main():
    ...
    with open(OUT_H, "w") as f:
        ...
        f.write("#ifndef CRASTER_ATLAS_GEN_H\n#define CRASTER_ATLAS_GEN_H\n\n")
        ...
        f.write("};\n\n")
        f.write("#endif /* CRASTER_ATLAS_GEN_H */\n")
