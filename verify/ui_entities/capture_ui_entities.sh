...
REQUIRED=(
  ...
  slime_size1 slime_size2 slime_size4 slime_squish slime_size2_glowing
  magma_size1 magma_size2 magma_size4 magma_squish magma_size2_glowing
  ...
  bat_flying bat_hanging bat_background
  squid_swim_pose squid_dry_pose squid_background
  ...
  horse_rearing horse_mouth horse_gait horse_tail horse_saddled_pose horse_child
  horse_particle_control horse_taming_smoke horse_breeding_heart
  donkey_chested_saddled mule_base skeleton_horse zombie_horse
  skeleton_trap_rider skeleton_trap_group skeleton_trap_group_background
  ...
  llama_decor_red llama_decor_black llama_gait llama_gray_decor_chest
  llama_child_decor llama_spit llama_background
  ...
  hanging_frame_empty hanging_frame_stick hanging_frame_dirt hanging_frame_map
