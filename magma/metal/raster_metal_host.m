...
_Static_assert(offsetof(CrShadeCtx, repeat_uv) == 96,
               "CrShadeCtx.repeat_uv");
_Static_assert(offsetof(CrShadeCtx, depth_d24) == 100,
               "CrShadeCtx.depth_d24");
_Static_assert(offsetof(CrShadeCtx, depth_bias_d24) == 104,
               "CrShadeCtx.depth_bias_d24");
_Static_assert(offsetof(CrShadeCtx, subpixel_bits) == 108,
               "CrShadeCtx.subpixel_bits");
_Static_assert(sizeof(CrShadeCtx) == 112,  "CrShadeCtx layout");
_Static_assert(sizeof(GmSkyCtx) == 100,    "GmSkyCtx layout");
