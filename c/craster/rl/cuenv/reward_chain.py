...
- Fully GPU-tensorized: step() takes the cuenv status/cam/pose/scal/done
...
# status column layout (cuenv_fill_status): 9 inv counts + hotbar_sel +
...
# inv item ids for the 9 status columns (must match CU_INV_IDS in cuenv_core.h)
...
class ChainReward:
    ...
    def step(self, status, cam, acts, pose, scal, done, lane_seed_t, log_t):
        ...
        status/cam/pose/scal/done: cuenv readouts for this decision.
