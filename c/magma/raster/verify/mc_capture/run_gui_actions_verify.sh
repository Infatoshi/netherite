...
make -s game/screen.o game/hud.o game/item_render.o game/container_live.o game/runtime.o \
...
gcc "${FLAGS[@]}" "$OUT/gui_actions_candidate.c" \
    game/screen.o game/hud.o game/item_render.o game/runtime.o game/fluid_live.o \
    ...
    core/math.o core/shade.o -lm -o "$OUT/gui_actions_candidate"
