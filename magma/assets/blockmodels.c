...
enum {
    ...
    CBX_GOLD_BLOCK = 278,
    CBX_LAPIS_BLOCK = 279,
    CBX_DIAMOND_BLOCK = 280,
    CBX_EMERALD_BLOCK = 281,
    CBX_REDSTONE_BLOCK = 282,
    CBX_COAL_BLOCK = 283,
    CBX_STAINED_GLASS_BASE = 284,
    CBX_STRUCTURE_BLOCK_BASE = 300,
    CBX_MAX = 304
};
...
static const BmBlock g_blocks[CBX_MAX] = {
    ...
    [CBX_GLASS_MAGENTA] = { 0, 0, CR_LAYER_TRANSLUCENT, BM_KIND_CUBE,
    ...
    /* beacon.json has three texture families rather than one per direction.
     * Store glass/base/inner in DOWN/UP/NORTH; emit_beacon expands the exact
     * three elements and their explicit face UVs. */
    [CBX_BEACON] = { 0, 0, CR_LAYER_CUTOUT, BM_KIND_BEACON, {
        {CR_SPRITE_GLASS, BM_TINT_NONE},
        {CR_SPRITE_OBSIDIAN, BM_TINT_NONE},
        {CR_SPRITE_BEACON, BM_TINT_NONE},
        {CR_SPRITE_BEACON, BM_TINT_NONE},
        {CR_SPRITE_BEACON, BM_TINT_NONE},
        {CR_SPRITE_BEACON, BM_TINT_NONE}
    }},
    [CBX_IRON_BLOCK] = CUBE6(CR_SPRITE_IRON_BLOCK, BM_TINT_NONE),
    [CBX_GOLD_BLOCK] = CUBE6(CR_SPRITE_GOLD_BLOCK, BM_TINT_NONE),
    [CBX_LAPIS_BLOCK] = CUBE6(CR_SPRITE_LAPIS_BLOCK, BM_TINT_NONE),
    [CBX_DIAMOND_BLOCK] = CUBE6(CR_SPRITE_DIAMOND_BLOCK, BM_TINT_NONE),
    [CBX_EMERALD_BLOCK] = CUBE6(CR_SPRITE_EMERALD_BLOCK, BM_TINT_NONE),
    [CBX_REDSTONE_BLOCK] = CUBE6(CR_SPRITE_REDSTONE_BLOCK, BM_TINT_NONE),
    [CBX_COAL_BLOCK] = CUBE6(CR_SPRITE_COAL_BLOCK, BM_TINT_NONE),
    [CBX_STAINED_GLASS_BASE + 0] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_WHITE, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 1] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_ORANGE, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 2] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_MAGENTA, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 3] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_LIGHT_BLUE, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 4] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_YELLOW, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 5] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_LIME, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 6] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_PINK, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 7] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_GRAY, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 8] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_SILVER, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 9] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_CYAN, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 10] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_PURPLE, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 11] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_BLUE, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 12] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_BROWN, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 13] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_GREEN, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 14] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_RED, BM_TINT_NONE) },
    [CBX_STAINED_GLASS_BASE + 15] = { 0, 0, CR_LAYER_TRANSLUCENT,
        BM_KIND_CUBE, FULL6(CR_SPRITE_GLASS_BLACK, BM_TINT_NONE) },
    [CBX_STRUCTURE_BLOCK_BASE + 0] =
        CUBE6(CR_SPRITE_STRUCTURE_BLOCK_SAVE, BM_TINT_NONE),
    [CBX_STRUCTURE_BLOCK_BASE + 1] =
        CUBE6(CR_SPRITE_STRUCTURE_BLOCK_LOAD, BM_TINT_NONE),
    [CBX_STRUCTURE_BLOCK_BASE + 2] =
        CUBE6(CR_SPRITE_STRUCTURE_BLOCK_CORNER, BM_TINT_NONE),
    [CBX_STRUCTURE_BLOCK_BASE + 3] =
        CUBE6(CR_SPRITE_STRUCTURE_BLOCK_DATA, BM_TINT_NONE),
};
...
static int bm_is_modeled(int id)
{
    ...
    case CBX_BEACON:
    case CBX_IRON_BLOCK: case CBX_GOLD_BLOCK: case CBX_LAPIS_BLOCK:
    case CBX_DIAMOND_BLOCK: case CBX_EMERALD_BLOCK:
    case CBX_REDSTONE_BLOCK: case CBX_COAL_BLOCK:
    case CBX_STRUCTURE_BLOCK_BASE + 0:
    case CBX_STRUCTURE_BLOCK_BASE + 1:
    case CBX_STRUCTURE_BLOCK_BASE + 2:
    case CBX_STRUCTURE_BLOCK_BASE + 3:
        return 1;
    default:
