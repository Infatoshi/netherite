...
void gm_dragon_respawn(
    GmDragonLive *d, long long seed, float yaw);
...
/* Read-only distance of the same crystal/dragon candidate selected above. */
int gm_dragon_player_attack_target(
    const GmDragonLive *d, const struct PsvPlayer *player,
