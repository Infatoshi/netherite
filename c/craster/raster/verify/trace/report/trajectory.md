...
Both games start pinned at the same pose (44.5 68.0 176.5 0.0 5.0, seed 0, frozen noon) and replay the SAME inputs: forward x60, right turn 90 deg (6x15), forward x60, jump at t=130/140/150, stand. Oracle obs recorded per tick; craster --state-out per tick. Frames diffed every 20 ticks WITHOUT pose forcing (each side renders its own simulated pose), so pixel divergence includes physics drift.
