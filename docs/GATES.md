...
| 4 | Port-matrix rows after spawn-to-torch: mobs, portals_dimensions, nether_route, dragon_victory, boats_elytra_xp. fluids, random_ticks, entity_spine, falling_blocks, weather_optional, chests, projectiles, and explosions VERIFIED 2026-08-22. | 2 | grindable DAG | anvil cpu then gpu |
