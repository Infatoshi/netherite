...
assets/hud_atlas.h. Also dumps /tmp/craster_hud_*.png for eyeballing.
...
def main():
    ...
    for sym, src, x, y, w, h in SPRITES:
        ...
        crop.save("/tmp/craster_hud_%s.png" % sym.lower())
    ...
    with open(OUT_H, "w") as f:
        ...
        f.write("#ifndef CRASTER_HUD_ATLAS_H\n#define CRASTER_HUD_ATLAS_H\n\n")
        ...
        f.write("};\n\n")
        f.write("#endif /* CRASTER_HUD_ATLAS_H */\n")
