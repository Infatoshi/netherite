...
50-case fixture matches raw target-health, motion, and fire state for the falling/on-ground,
...
exact as well.
Critical/enchantment sounds and
particles, sweeping, Thorns, player-target velocity
...
OpenAL playback for 140 events/441 owned OGG variants, including four bounded
...
controls, the exact Java asset-variant cursor, visual splash particles, broader
client-side particle RNG consumers, and output comparison remain open. Player
...
unrendered particle draws before any later sound.
