...
make -s game/screen.o game/player_preview.o game/hud.o game/item_render.o game/container_live.o game/runtime.o game/nbt_blob.o \
    ...
    game/live_sim.o game/randtick.o game/mob_live.o game/dragon_live.o game/structures_live.o game/village_live.o game/villager_trade.o \
    game/end_city_live.o game/end_population_live.o game/mansion_live.o \
...
gcc "${FLAGS[@]}" "$OUT/gui_actions_candidate.c" \
    ...
    game/randtick.o game/mob_live.o game/dragon_live.o game/structures_live.o game/village_live.o game/villager_trade.o \
    game/end_city_live.o game/end_population_live.o game/mansion_live.o game/portal_live.o \
