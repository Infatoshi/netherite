...
make -s game/screen.o game/player_preview.o game/hud.o game/item_render.o game/container_live.o game/runtime.o \
    ...
    game/portal_live.o game/furnace_live.o game/chest_live.o game/caps.o core/config.o world/light.o world/mesh_mc.o \
...
gcc "${FLAGS[@]}" "$OUT/gui_actions_candidate.c" \
    ...
    game/furnace_live.o game/chest_live.o game/container_live.o game/caps.o core/config.o world/light.o \
