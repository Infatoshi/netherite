...
Feature pipeline mirrors rl/blaze/ppo_chain_cu.py exactly, computed from the
...
Run (anvil):
  cd c/magma && CHAIN_NET=chain_net_cu.pt uv run --no-project \
...
from look_at_tree import MagmaEnv, EYE, wrap180            # noqa: E402
