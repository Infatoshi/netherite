 ...
 * (mc-sim container_click.h) supplies the stack helpers; this module owns the unified
...
#ifndef CRASTER_GAME_CONTAINER_LIVE_H
#define CRASTER_GAME_CONTAINER_LIVE_H
...
#endif /* CRASTER_GAME_CONTAINER_LIVE_H */
