...
#define GM_MODEL_BEACON 276
#define GM_MODEL_IRON_BLOCK 277
#define GM_MODEL_GOLD_BLOCK 278
#define GM_MODEL_LAPIS_BLOCK 279
#define GM_MODEL_DIAMOND_BLOCK 280
#define GM_MODEL_EMERALD_BLOCK 281
#define GM_MODEL_REDSTONE_BLOCK 282
#define GM_MODEL_COAL_BLOCK 283
#define GM_MODEL_STAINED_GLASS_BASE 284
#define GM_MODEL_STRUCTURE_BLOCK_BASE 300
...
static inline int gm_model_key_to_state(int key, int raw_meta, uint16_t *out) {
    ...
    switch (key) {
        ...
        case GM_MODEL_BEACON: id = 138; break;      /* Beacon static model */
        case GM_MODEL_IRON_BLOCK: id = 42; break;
        case GM_MODEL_GOLD_BLOCK: id = 41; break;
        case GM_MODEL_LAPIS_BLOCK: id = 22; break;
        case GM_MODEL_DIAMOND_BLOCK: id = 57; break;
        case GM_MODEL_EMERALD_BLOCK: id = 133; break;
        case GM_MODEL_REDSTONE_BLOCK: id = 152; break;
        case GM_MODEL_COAL_BLOCK: id = 173; break;
        case GM_MODEL_STRUCTURE_BLOCK_BASE + 0: id = 255; meta = 0; break;
        case GM_MODEL_STRUCTURE_BLOCK_BASE + 1: id = 255; meta = 1; break;
        case GM_MODEL_STRUCTURE_BLOCK_BASE + 2: id = 255; meta = 2; break;
        case GM_MODEL_STRUCTURE_BLOCK_BASE + 3: id = 255; meta = 3; break;
        default: break;
    }
    ...
    if (key >= GM_MODEL_STAINED_GLASS_BASE
            && key < GM_MODEL_STAINED_GLASS_BASE + 16) {
        id = 95;
        meta = key - GM_MODEL_STAINED_GLASS_BASE;
        quality = GM_MAP_EXACT;
    }
...
static inline int gm_state_to_model_key(uint16_t state) {
    ...
    switch (id) {
        ...
        case 30: return 230;
        case 21: return 29;
        case 22: return GM_MODEL_LAPIS_BLOCK;
        ...
        case 39: return 42;
        case 40: return 43;
        case 41: return GM_MODEL_GOLD_BLOCK;
        case 42: return GM_MODEL_IRON_BLOCK;
        case 44:
        ...
        case 52: return 47;
        case 53: return 201;
        case 54: return 0;                        /* Chest is TESR-only */
        case 56: return 28;
        case 57: return GM_MODEL_DIAMOND_BLOCK;
        ...
        case 89: return 214;
        case 90: return 211;
        case 95: return GM_MODEL_STAINED_GLASS_BASE + (meta & 15);
        ...
        case 129: return 75;
        case 130: return 0;                       /* Ender Chest is TESR-only */
        case 133: return GM_MODEL_EMERALD_BLOCK;
        case 138: return GM_MODEL_BEACON;
        case 146: return 0;                       /* Trapped Chest is TESR-only */
        case 139: return 233;
        case 153: return 217;
        case 152: return GM_MODEL_REDSTONE_BLOCK;
        case 159: return meta == 1 ? 96 : meta == 11 ? 97 : 120 + (meta & 15);
        case 161: return (meta & 1) ? 78 : 83;
        case 162: return (meta & 1) ? 77 : 82;
        case 165: return 229;
        case 172: return 17;
        case 173: return GM_MODEL_COAL_BLOCK;
        case 174: return 231;
        ...
        case 213: return 220;
        case 216: return 48;
        case 255: return GM_MODEL_STRUCTURE_BLOCK_BASE + (meta & 3);
        ...
        case 231: case 232: case 233: case 234:
            return 0;                            /* Shulker boxes are TESR-only */
