/* CUDA: same core/caves_real.h as CPU; single-thread worldgen on device. */
#include <cstdio>
#include <cstdlib>
#include "../core/caves_real.h"

__global__ void run_cvr(i64 seed, const McSinTable *st, ChunkPrimer *primer, CvrScratch *ctx) {
...
int main(int argc, char **argv) {
    ...
    run_cvr<<<1, 1>>>(seed, d_st, d_primer, d_ctx);
