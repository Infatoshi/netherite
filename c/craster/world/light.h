/* world/light.h - LIGHT module public contract for craster.
 *
 * Computes Minecraft-1.11.2-faithful sky light, block light, and biome tint
 * colors over the mc-sim voxel world so the mesher can light/tint vertices.
 *
 * Blocks are read from mc-sim (core/chunk_provider.h : cp_provide_chunk) and are
 ...
 */
#ifndef CRASTER_WORLD_LIGHT_H
#define CRASTER_WORLD_LIGHT_H
