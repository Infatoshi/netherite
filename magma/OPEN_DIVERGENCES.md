...
canonical t=260 texel-selection; entities over water; slime rim (oracle
translucent DRAW dump); rain lightmap (rain tape exists); portal/underwater
C residual (Oracle A/B now maxch=0).
