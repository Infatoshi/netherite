...
`make -C c/craster game` builds one native Minecraft 1.11.2 simulation binary. In a
...
```text
craster_game --headless --ticks N --script events.jsonl \
