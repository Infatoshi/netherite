...
enum {
    ...
    BLK_LAPIS_ORE = 21, BLK_SANDSTONE = 24,
    BLK_OBSIDIAN = 49, BLK_TORCH = 50, BLK_DIAMOND_ORE = 56, BLK_REDSTONE_ORE = 73,
    BLK_SNOW_LAYER = 78, BLK_ICE = 79, BLK_CLAY = 82, BLK_NETHERRACK = 87,
    BLK_SOUL_SAND = 88, BLK_GLOWSTONE = 89, BLK_END_STONE = 121, BLK_EMERALD_ORE = 129,
    BLK_MAX = 256
};
