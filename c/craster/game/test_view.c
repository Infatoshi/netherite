 ...
 * where I'm looking" bug: cam_from_view used craster_yaw = mc_yaw - 180 (an
 ...
 *      ported in mc-sim core/player_physics_full.h)
...
/* World-space forward of the craster camera for an MC-convention yaw/pitch:
