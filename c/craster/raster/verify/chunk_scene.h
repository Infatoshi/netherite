...
#ifndef CRASTER_VERIFY_CHUNK_SCENE_H
#define CRASTER_VERIFY_CHUNK_SCENE_H
...
static inline void chunkscene_init(ChunkScene *s, int W, int H) {
     ...
     * teleported to craster's PRINTED pose, which at capture time was the
    ...
    /* CRASTER_NO_CULL=1 meshes EVERY chunk in the radius (frustum test disabled).
...
#endif /* CRASTER_VERIFY_CHUNK_SCENE_H */
