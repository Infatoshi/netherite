...
final class MineshaftOracle {
    ...
    private static JsonObject loot(WorldServer world, long seed,
    ...
    static JsonObject loot(WorldServer world, long seed) {
        return loot(world, seed, LootTableList.CHESTS_ABANDONED_MINESHAFT);
    }

    static JsonObject iglooLoot(WorldServer world, long seed) {
        return loot(world, seed,
