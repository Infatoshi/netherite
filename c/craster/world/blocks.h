/* craster world: block appearance + classification table (internal to the world module).
 * Maps mc-sim CB_* block ids to a procedural-atlas tile index and a base colour,
...
#ifndef CRASTER_WORLD_BLOCKS_H
#define CRASTER_WORLD_BLOCKS_H
