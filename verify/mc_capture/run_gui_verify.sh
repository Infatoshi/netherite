...
make -s game/screen.o game/player_preview.o game/hud.o game/item_render.o game/container_live.o game/runtime.o game/nbt_blob.o game/fluid_live.o game/config.o \
    ...
    game/end_city_live.o game/end_population_live.o game/mansion_live.o game/portal_live.o game/furnace_live.o \
...
gcc "${FLAGS[@]}" "$OUT/gui_candidate.c" \
    ...
    game/randtick.o game/structures_live.o game/village_live.o game/villager_trade.o \
    game/end_city_live.o game/end_population_live.o game/mansion_live.o game/portal_live.o game/furnace_live.o game/chest_live.o game/brewing_live.o game/enchanting_live.o \
...
CANDIDATE_ARGS=()
if [ -n "${GUI_PREVIEW_COLOR_MODE:-}" ]; then
    CANDIDATE_ARGS+=(--set "preview_color_mode=$GUI_PREVIEW_COLOR_MODE")
fi
"$OUT/gui_candidate" "${CANDIDATE_ARGS[@]}" --container 1 --w 854 --h 480 --ppm "$OUT/magma_gui_table.ppm"
"$OUT/gui_candidate" "${CANDIDATE_ARGS[@]}" --container 2 --w 854 --h 480 --ppm "$OUT/magma_gui_furnace.ppm"
"$OUT/gui_candidate" "${CANDIDATE_ARGS[@]}" --container 0 --w 854 --h 480 --ppm "$OUT/magma_gui_inventory.ppm"
"$OUT/gui_candidate" "${CANDIDATE_ARGS[@]}" --container 3 --w 854 --h 480 --ppm "$OUT/magma_gui_chest.ppm"
...
"$OUT/gui_candidate" "${CANDIDATE_ARGS[@]}" --container 0 --w 854 --h 480 --mx 282 --my 258 \
