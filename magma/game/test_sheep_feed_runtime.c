...
static void test_component_boost(void) {
    ...
    CHECK(gm_mobs_pig_boost(&m, &inv, 0, 0)
              ...
              && m.entity_random[
                  gm_mobs_find_slot_by_eid(&m, m.pig_ride_eid)].random.seed
...
static void test_component_pig_death_drop(void) {
    ...
    CHECK(runtime.mobs.entity_dead[pig_slot]
              ...
              && runtime.mobs.pig_ride_eid == pig_eid
    ...
    for (int tick = 1; tick <= 19; ++tick) {
        gm_mobs_tick(
            ...
            runtime.clock.world_time, &runtime.clock, runtime.mob_griefing,
...
static void test_runtime_feed(void) {
    ...
    }
    {
        ...
        int riding_slot = gm_mobs_find_slot_by_eid(
            &r.mobs, r.mobs.pig_ride_eid);
        r.mobs.controlled_no_ai[riding_slot] = 0;
        r.mobs_enabled = 1;
        double before_z = store(&r.mobs)->z[riding_slot];
        ...
        riding_slot = gm_mobs_find_slot_by_eid(
            &r.mobs, r.mobs.pig_ride_eid);
        CHECK(store(&r.mobs)->z[riding_slot] > before_z,
    ...
    r.mobs.controlled_no_ai[gm_mobs_find_slot_by_eid(
        &r.mobs, r.mobs.pig_ride_eid)] = 0;
    r.mobs_enabled = 1;
    gm_runtime_tick(
        &r, (GmAction){.hotbar_sel = -1, .do_place = 1});
