...
// Forge terrain-gen stage boundary, per chunk. Ground truth for the craster/mc-sim
// worldgen flywheel (c/craster/trace/genprobe_diff.py): the first checkpoint whose
...
public class WorldGenProbe {
    ...
    // Elapsed-ticks feed for the fluid-CA-timing replay (see c/craster SPEC / DEVLOG): the
