...
# craster at the MC client resolution/pose (rung4_candidate) and whole-frame
...
CAND_PNG="$OUT/craster_frame.png"
...
# Save a PNG copy of the craster frame next to the golden for eyeballing.
...
# Terrain crop: lower-center band where BOTH craster and MC show ground (excludes
# the pure-sky top quarter and the left/right sky-void wedges of craster's island).
TCROP="180:479,180:674"

echo
echo "== whole-frame diff (craster vs MC golden) =="
...
if not ok:
    ...
    print("hint: see c/craster/VERIFY.md for the harsh bar")
