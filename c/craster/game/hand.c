/* game/hand.c - first-person HAND / HELD ITEM for craster_game.
 *
 * APPROACH (A): REAL 3D geometry through the craster pipeline, not a 2D blit.
 ...
 *
 * DOUBLE-SIDED: MC calls GlStateManager.disableCull for the arm; craster's
