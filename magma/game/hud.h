...
/* Exact GuiButton widgets.png chrome for an arbitrary even vanilla width.
 * x/y/w/h are framebuffer pixels; label metrics use `scale` GUI pixels. */
...
enum {
    ...
    GM_GUI_ENCHANTING_OPTION_DISABLED,
    GM_GUI_ENCHANTING_OPTION_HOVER,
    GM_GUI_ENCHANTING_ICON0,
    GM_GUI_ENCHANTING_ICON1,
    GM_GUI_ENCHANTING_ICON2,
    GM_GUI_ENCHANTING_ICON0_DISABLED,
    GM_GUI_ENCHANTING_ICON1_DISABLED,
    GM_GUI_ENCHANTING_ICON2_DISABLED,
    GM_GUI_ENCHANTING_SGA_FONT,
    GM_GUI_ENCHANTING_BOOK,
    GM_GUI_ANVIL_PANEL,
    GM_GUI_ANVIL_NAME_ACTIVE,
    GM_GUI_ANVIL_NAME_INACTIVE,
    GM_GUI_ANVIL_INVALID,
    GM_GUI_MERCHANT_PANEL,
    GM_GUI_MERCHANT_NEXT_NORMAL,
    GM_GUI_MERCHANT_NEXT_HOVER,
    GM_GUI_MERCHANT_NEXT_DISABLED,
    GM_GUI_MERCHANT_PREV_NORMAL,
    GM_GUI_MERCHANT_PREV_HOVER,
    GM_GUI_MERCHANT_PREV_DISABLED,
    GM_GUI_MERCHANT_DISABLED,
    GM_GUI_HORSE_PANEL,
    GM_GUI_HORSE_CHEST,
    GM_GUI_HORSE_SADDLE,
    GM_GUI_HORSE_ARMOR,
    GM_GUI_HORSE_LLAMA_DECOR,
    GM_GUI_SHULKER_PANEL,
    GM_GUI_BEACON_PANEL,
    GM_GUI_BEACON_BUTTON_NORMAL,
    GM_GUI_BEACON_BUTTON_SELECTED,
    GM_GUI_BEACON_BUTTON_DISABLED,
    GM_GUI_BEACON_BUTTON_HOVER,
    GM_GUI_BEACON_CONFIRM,
    GM_GUI_BEACON_CANCEL,
    GM_GUI_BEACON_SPEED,
    GM_GUI_BEACON_HASTE,
    GM_GUI_BEACON_RESISTANCE,
    GM_GUI_BEACON_JUMP,
    GM_GUI_BEACON_STRENGTH,
    GM_GUI_BEACON_REGENERATION,
    GM_GUI_DISPENSER_PANEL,
    GM_GUI_HOPPER_PANEL,
    GM_GUI_POTION_OVERLAY
};
