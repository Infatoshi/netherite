...
def main():
    ...
    dump = Path("/tmp/craster_atlas_board.png")
    build = repo / "c/craster/assets/build_atlas.py"
    ...
    candidates = [
        Path("/tmp/grok-goal-a3c013c69dd0/implementer/craster_atlas.png"),
        Path("/tmp/craster_atlas.png"),
    ]
    ...
    h = (repo / "c/craster/assets/atlas_gen.h").read_text()
