 ...
 * as raster/verify/chunk_scene.h does (so a fresh world at the frozen pose meshes
 * byte-identically), and re-meshes only dirty / newly-visible chunks. Block ids are the
 * mc-sim CB_*/PB_* small ints read through the CrLight store.
 */
#ifndef CRASTER_GAME_WORLD_LIVE_H
#define CRASTER_GAME_WORLD_LIVE_H

#include "core/types.h"
#include "game/game.h"

#endif /* CRASTER_GAME_WORLD_LIVE_H */
