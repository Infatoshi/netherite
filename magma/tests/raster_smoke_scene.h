/* Raster smoke scene contract. Do not change signatures without updating SPEC.md. */
 ...
 * dirt/grass tiles). texels point to static storage owned by the scene; do NOT free. */
