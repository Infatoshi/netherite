 ...
 * integers emitted by mc-sim worldgen are model keys only. They overlap vanilla
 * ids (PB 61 is a double plant while vanilla 61 is a furnace), so an untagged
 * integer can never safely serve both roles.
 */
#ifndef CRASTER_GAME_BLOCK_REGISTRY_H
#define CRASTER_GAME_BLOCK_REGISTRY_H
...
#endif /* CRASTER_GAME_BLOCK_REGISTRY_H */
