...
echo "automation_oracle: PASS (hopper, furnace/brewing sides, ordinary/trapped double chests, shulker boxes, exact multi-slot selection, dropper, and broad dispenser behavior coverage)"
