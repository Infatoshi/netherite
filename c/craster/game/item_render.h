/* game/item_render.h - dropped-item (EntityItem) + GUI block icons for craster.
 *
 ...
 */
#ifndef CRASTER_GAME_ITEM_RENDER_H
#define CRASTER_GAME_ITEM_RENDER_H
...
#endif
#endif /* CRASTER_GAME_ITEM_RENDER_H */
