...
CAPTURE_SH = os.path.join(MAGMA, "raster/verify/mc_capture/capture_at_poses.sh")
AERIAL_GOLDEN = os.path.join(MAGMA, "raster/verify/mc_capture/mc_frame.png")

EYE_HEIGHT = 1.62      # PSV_EYE_HEIGHT (mc-sim player_survival.h); MC + magma agree
