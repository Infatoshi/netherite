...
public class EntityList
{
    ...
    static
    {
        ...
        // stripped: addMapping(EntitySlime.class, "Slime", 55, 5349438, 8306542);
        ...
        // stripped: addMapping(EntityCaveSpider.class, "CaveSpider", 59, 803406, 11013646);
        addMapping(EntitySilverfish.class, "Silverfish", 60, 7237230, 3158064);
        addMapping(EntityBlaze.class, "Blaze", 61, 16167425, 16775294);
        // stripped: addMapping(EntityMagmaCube.class, "LavaSlime", 62, 3407872, 16579584);
        addMapping(EntityDragon.class, "EnderDragon", 63);
        // stripped: addMapping(EntityWither.class, "WitherBoss", 64);
        addMapping(EntityBat.class, "Bat", 65, 4996656, 986895);
        // stripped: addMapping(EntityWitch.class, "Witch", 66, 3407872, 5349438);
        ...
        // stripped: addMapping(EntityWolf.class, "Wolf", 95, 14144467, 13545366);
        addMapping(EntityMooshroom.class, "MushroomCow", 96, 10489616, 12040119);
        // stripped: addMapping(EntitySnowman.class, "SnowMan", 97);
        // stripped: addMapping(EntityOcelot.class, "Ozelot", 98, 15720061, 5653556);
        // stripped: addMapping(EntityIronGolem.class, "VillagerGolem", 99);
        // stripped: addMapping(EntityHorse.class, "EntityHorse", 100, 12623485, 15656192);
        // stripped: addMapping(EntityVillager.class, "Villager", 120, 5651507, 12422002);
