/* craster world contract: seed -> chunk voxels (via mc-sim) -> visible-face mesh.
 * Shared by the world .c files (impl) and app/main.c (consumer). Do not change signatures
 * without updating SPEC.md. Block ids are mc-sim CB_* small ints (0 = CB_AIR). */
#ifndef CRASTER_WORLD_H
#define CRASTER_WORLD_H
