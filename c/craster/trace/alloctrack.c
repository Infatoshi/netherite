/* trace/alloctrack.c - LD_PRELOAD allocation tripwire for craster_game.
 *
 ...
 *     CRASTER_VIEW_RADIUS=8 ./craster_game --seed 19 --frames 60
 *
...
static void summary(void) {
    ...
    fprintf(stderr, "[alloctrack] (offset = pc - fbase; resolve with: addr2line -f -e craster_game_dbg <offset>)\n");
