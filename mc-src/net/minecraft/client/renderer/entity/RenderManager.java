...
// stripped: import net.minecraft.client.model.ModelHorse;
// stripped: import net.minecraft.client.model.ModelOcelot;
import net.minecraft.client.model.ModelPig;
import net.minecraft.client.model.ModelSheep1;
import net.minecraft.client.model.ModelSheep2;
// stripped: import net.minecraft.client.model.ModelSlime;
import net.minecraft.client.model.ModelSquid;
// stripped: import net.minecraft.client.model.ModelWolf;
...
// stripped: import net.minecraft.entity.monster.EntityCaveSpider;
import net.minecraft.entity.monster.EntityCreeper;
import net.minecraft.entity.monster.EntityEnderman;
import net.minecraft.entity.monster.EntityGhast;
import net.minecraft.entity.monster.EntityGiantZombie;
// stripped: import net.minecraft.entity.monster.EntityIronGolem;
// stripped: import net.minecraft.entity.monster.EntityMagmaCube;
...
public class RenderManager
{
    ...
    {
        // stripped: this.entityRenderMap.put(EntityCaveSpider.class, new RenderCaveSpider());
        ...
        // stripped: this.entityRenderMap.put(EntityWolf.class, new RenderWolf(new ModelWolf(), new ModelWolf(), 0.5F));
        this.entityRenderMap.put(EntityChicken.class, new RenderChicken(new ModelChicken(), 0.3F));
        // stripped: this.entityRenderMap.put(EntityOcelot.class, new RenderOcelot(new ModelOcelot(), 0.4F));
        ...
        // stripped: this.entityRenderMap.put(EntitySnowman.class, new RenderSnowMan());
        this.entityRenderMap.put(EntitySkeleton.class, new RenderSkeleton());
        // stripped: this.entityRenderMap.put(EntityWitch.class, new RenderWitch());
        this.entityRenderMap.put(EntityBlaze.class, new RenderBlaze());
        this.entityRenderMap.put(EntityZombie.class, new RenderZombie());
        // stripped: this.entityRenderMap.put(EntitySlime.class, new RenderSlime(new ModelSlime(16), new ModelSlime(0), 0.25F));
        // stripped: this.entityRenderMap.put(EntityMagmaCube.class, new RenderMagmaCube());
        ...
        // stripped: this.entityRenderMap.put(EntityVillager.class, new RenderVillager());
        // stripped: this.entityRenderMap.put(EntityIronGolem.class, new RenderIronGolem());
        ...
        // stripped: this.entityRenderMap.put(EntityWither.class, new RenderWither());
        ...
        // stripped: this.entityRenderMap.put(EntityHorse.class, new RenderHorse(new ModelHorse(), 0.75F));
