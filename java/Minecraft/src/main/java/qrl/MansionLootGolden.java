...
/** Real 1.11.2 woodland_mansion fillInventory oracle. */
public final class MansionLootGolden {
    ...
    public static void main(String[] args) {
        ...
        LootContext context = new LootContext(0.0F, null, manager,
            null, null, null);
        for (long seed : SEEDS) {
            InventoryBasic inventory = new InventoryBasic("mansion", false, 27);
