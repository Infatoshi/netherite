 ...
 * pulls in the mc-sim types (Chunk / McSinTable / PsvPlayer) so a translation unit
 * that includes player_ctl.h alone can call them. See game/game.h for the contract.
 */
#ifndef CRASTER_GAME_PLAYER_CTL_H
#define CRASTER_GAME_PLAYER_CTL_H
 ...
 * mc-sim Chunk structs. pl->ent position is in the window LOCAL frame (chunk 0 == region
...
#endif
#endif /* CRASTER_GAME_PLAYER_CTL_H */
