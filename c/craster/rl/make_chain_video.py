...
Replays rl/out/chain_actions_s<seed>.json through ONE craster process in rl
...
Run (anvil): cd c/craster && uv run --no-project --with numpy,pillow python rl/make_chain_video.py [seed]
"""
import json
import os
import shutil
...
from make_videos import CRASTER, OUT, COLORS, CAM_W, CAM_H, SCALE, encode
