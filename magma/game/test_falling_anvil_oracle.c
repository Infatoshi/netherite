...
int main(int argc, char **argv) {
    ...
    FallingRow rows[20]; ScheduledRow on_added[32], after_loss[32], final[32];
    ...
    memset(r.falling_blocks, 0, (size_t)r.falling_blocks_cap * sizeof *r.falling_blocks);
    ...
    int on_added_count = snapshot_scheduled(&r, on_added, 32);
    ...
    if (unsupported || capacity) {
        ...
        after_loss_count = snapshot_scheduled(&r, after_loss, 32);
    ...
    int final_count = snapshot_scheduled(&r, final, 32);
