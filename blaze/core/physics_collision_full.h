 ...
 * entry, and block-specific landing callbacks. The shared living wrapper supplies slime
 * contacts and applies BlockSlime.onLanded/onEntityWalk after this sweep.
 *
