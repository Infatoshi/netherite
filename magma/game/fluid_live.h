...
/* Retire approximate CA regions overlapping an exact scheduled-fluid proof
 * region. Remote live-flow regions remain active. */
void gm_fluid_forget_near(
    GmFluidLive *f, int dim, int wx, int wy, int wz, int distance);
