...
MC_HD static inline BptProps mc_bpt_props(int id) {
    ...
    switch (id) {
        ...
        case 6: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 7: d = (BptProps){ -1.0f, 0, 255, 1 }; break;
        case 8: d = (BptProps){ 100.0f, 0, 3, 22 }; break;
        case 9: d = (BptProps){ 100.0f, 0, 3, 6 }; break;
        case 10: d = (BptProps){ 100.0f, 15, 0, 22 }; break;
        case 11: d = (BptProps){ 100.0f, 15, 0, 22 }; break;
        ...
        case 31: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 32: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 37: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 38: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 39: d = (BptProps){ 0.0f, 1, 0, 20 }; break;
        case 40: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        ...
        case 50: d = (BptProps){ 0.0f, 14, 0, 20 }; break;
        case 51: d = (BptProps){ 0.0f, 15, 0, 20 }; break;
        /* BlockMobSpawner overrides isOpaqueCube during Block construction,
         * so its registered lightOpacity is zero despite Material.ROCK. */
        case 52: d = (BptProps){ 5.0f, 0, 0, 1 }; break;
        ...
        case 60: d = (BptProps){ 0.6f, 0, 255, 17 }; break;
        ...
        case 74: d = (BptProps){ 3.0f, 9, 255, 17 }; break;
        case 78: d = (BptProps){ 0.1f, 0, 0, 20 }; break;
        case 79: d = (BptProps){ 0.5f, 0, 3, 17 }; break;
        case 80: d = (BptProps){ 0.2f, 0, 255, 17 }; break;
        case 81: d = (BptProps){ 0.4f, 0, 255, 17 }; break;
        case 82: d = (BptProps){ 0.6f, 0, 255, 1 }; break;
        case 83: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 85: d = (BptProps){ 2.0f, 0, 0, 1 }; break;
        case 86: d = (BptProps){ 1.0f, 0, 255, 17 }; break;
        case 87: d = (BptProps){ 0.4f, 0, 255, 1 }; break;
        case 88: d = (BptProps){ 0.5f, 0, 255, 1 }; break;
        case 89: d = (BptProps){ 0.3f, 15, 255, 1 }; break;
        case 90: d = (BptProps){ -1.0f, 11, 0, 16 }; break;
        case 91: d = (BptProps){ 1.0f, 15, 255, 17 }; break;
        case 92: d = (BptProps){ 0.5f, 0, 0, 17 }; break;
        ...
        case 104: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 105: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 106: d = (BptProps){ 0.2f, 0, 0, 20 }; break;
        case 107: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 108: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 109: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 110: d = (BptProps){ 0.6f, 0, 255, 17 }; break;
        case 111: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        ...
        case 127: d = (BptProps){ 0.2f, 0, 255, 17 }; break;
        ...
        case 138: d = (BptProps){ 3.0f, 15, 0, 1 }; break;
        case 139: d = (BptProps){ 2.0f, 0, 0, 1 }; break;
        case 140: d = (BptProps){ 0.0f, 0, 255, 1 }; break;
        case 141: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 142: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        ...
        case 200: d = (BptProps){ 0.4f, 0, 255, 17 }; break;
        ...
        case 207: d = (BptProps){ 0.0f, 0, 0, 20 }; break;
        case 212: d = (BptProps){ 0.5f, 0, 3, 17 }; break;
        case 213: d = (BptProps){ 0.5f, 0, 255, 17 }; break;
        ...
        case 231: case 232: case 233: case 234:
            d = (BptProps){ 2.0f, 0, 0, BF_SOLID }; break;
        default: break;
    }
    /* Block.getTickRandomly(), exhaustively captured from the initialized
     * 1.11.2 registry. Keep this independent of the gameplay/material table:
     * several registered client/redstone blocks intentionally use fallback
     * physical properties here but still participate in WorldServer's natural
     * callback dispatch. */
    switch (id) {
        case 2: case 6: case 8: case 10: case 11: case 18: case 28:
        case 31: case 32: case 37: case 38: case 39: case 40: case 50:
        case 51: case 59: case 60: case 70: case 72: case 74: case 75:
        case 76: case 77: case 78: case 79: case 80: case 81: case 83:
        case 86: case 90: case 91: case 92: case 104: case 105: case 106:
        case 110: case 111: case 115: case 127: case 131: case 132:
        case 141: case 142: case 143: case 147: case 148: case 161:
        case 171: case 175: case 200: case 207: case 212: case 213:
            d.flags |= BF_TICK_RANDOM;
            break;
        default:
            break;
    }
