# ROUTE.md - scripted seed-0 route: spawn to dragon kill, verified in craster
...
taped segment by segment, each segment replayed through craster and
pixel-matched before the next is added. Deliverable: side-by-side MP4 of the
dragon death (oracle vs craster).
...
|10 | mp4       | side-by-side oracle/craster MP4 of the dragon death      | DONE (dragon_death_sbs.mp4 t31700-32651 + dragon_fight_sbs.mp4 t29000+, scp'd to macbook:~/Downloads 2026-07-13) |
...
9 e2e: chain the segment drives on one save without world resets. Landed at
  ...
  final poll.
10 mp4: ffmpeg hstack oracle f_*.png vs craster_frames.npy frames, scp to Mac
