#!/usr/bin/env python3
"""grind.py - rank every keyframe divergence and emit triptychs (oracle | craster | diff-heatmap x4).
...
Reads the tape's oracle frames dir + the newest matching out/tape_*/craster_frames.npy.
...
npy = os.path.join(here, "out", "tape_" + name, "craster_frames.npy")
