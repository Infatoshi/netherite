...
REQUIRED=(
  ...
  hud_boss_half hud_wither_half hud_death
  gui_crafting_table gui_anvil gui_merchant gui_enchanting
  gui_furnace gui_brewing_stand
  gui_dispenser gui_dropper gui_hopper
  gui_ender_chest gui_large_chest gui_shulker_box gui_beacon
  gui_horse_armor gui_horse_donkey_chest gui_horse_llama_chest
