...
|---|-----------|------|-------|------|
| 1 | Native `out/blaze/rl/ppo` reproduces spawn->torch (t0 ~0.4, transfer ~11/13). Wood-break t0 0.495 matched (2026-08-21). 2026-09-03 re-run, mb=8192, 3 seeds: 08-21 tree best 0.60-0.66, wip/nn-fable 14b2698 best 0.05-0.41 (sealed path dropped the tail minibatch); fixed by tail_mb=overlap (059168c) at 0.53-0.62. Wall closed 2026-09-04 (f4c9bed): first-edit skylight straggler removed, 3 seeds 61-71 s vs 64-70 s on 08-21, best t0 0.525/0.615/0.560 unchanged. Staged-curriculum chain4 (2026-08-22) reached t0 0.215 at 510M ticks, stage4->torch 8/8 seeds; spawn->torch t0 ~0.4 still open. | 2 | grindable | anvil gpu0 |
