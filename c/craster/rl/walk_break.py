...
Run (anvil): cd c/craster && uv run --no-project --with numpy,torch,matplotlib python rl/walk_break.py
"""
import json
import math
import os
...
from look_at_tree import CrasterEnv, log_dirs
...
def main():
    ...
    for ep in range(N_EPISODES):
        envs = list(pool.map(CrasterEnv, SEEDS))
