/* CUDA: same core/tree_gen_oak_real.h as CPU; single-thread worldgen on device. */
#include <cstdio>
#include <cstdlib>
#include "../core/tree_gen_oak_real.h"

__global__ void run_tgor(i64 seed, ChunkPrimer *primer, CpScratch *sc) {
...
int main(int argc, char **argv) {
    ...
    run_tgor<<<1, 1>>>(seed, d_primer, d_sc);
