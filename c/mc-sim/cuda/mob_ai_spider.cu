/* CUDA driver for mob_ai_spider - SAME core/mob_ai_spider.h as CPU.
...
__global__ void run_mob_ai_spider(i64 seed, int nticks, MasTickOut *out, PfWork *work) {
...
int main(int argc, char **argv) {
    ...
    run_mob_ai_spider<<<1, 1>>>(seed, nticks, d_out, d_work);
