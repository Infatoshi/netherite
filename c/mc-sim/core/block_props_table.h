 ...
 *
 * KEEP (155 ids): survival terrain/ores/fluids/wood/tools blocks/furnace/chest/crafting_table/torches,
 ...
 * repeater/comparator/rails/tripwire/pressure plates/daylight sensor/redstone block/lamp/torch wire),
...
MC_HD static inline BptProps mc_bpt_props(int id) {
    ...
    switch (id) {
        ...
        case 10: d = (BptProps){ 100.0f, 15, 255, 6 }; break;
        case 11: d = (BptProps){ 100.0f, 15, 255, 6 }; break;
        ...
        case 54: d = (BptProps){ 2.5f, 0, 255, 1 }; break;
        ...
        case 65: d = (BptProps){ 0.4f, 0, 255, 1 }; break;
        ...
        case 85: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        ...
        case 113: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        ...
        case 118: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        ...
        case 188: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 189: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 190: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 191: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
        case 192: d = (BptProps){ 2.0f, 0, 255, 1 }; break;
