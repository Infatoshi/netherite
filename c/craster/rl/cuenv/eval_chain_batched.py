...
Run: cd c/craster && CHAIN_NET=chain_net_cu.pt uv run --no-project \
       --with numpy,torch python rl/cuenv/eval_chain_batched.py
"""
import os
import sys
...
from cuenv import VecCuEnv, CUDA_SO                          # noqa: E402
...
DEVICE = int(os.environ.get("CUENV_DEV", 0))
...
def main():
    ...
    env = VecCuEnv(n, device=DEVICE, so_path=CUDA_SO)
