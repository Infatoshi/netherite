...
DROP="$ROOT/c/render-opt/dropin/ao"
echo "$MODE" > "$DROP/qao_mode.txt"
echo "off"   > "$ROOT/c/render-opt/dropin/qsin_mode.txt"
echo "off"   > "$ROOT/c/render-opt/dropin/lightmap/qlm_mode.txt"
echo "off"   > "$ROOT/c/render-opt/dropin/biome/qbiome_mode.txt"
